package com.arrowwould.workout.man.reminderNew
...
import com.arrowwould.workout.man.activity.HomeActivity
...
class AlarmReceiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        val id = intent.getStringExtra(ConstantString.EXTRA_REMINDER_ID)
    ...
    fun setAlarm(context: Context, calendar: Calendar, ID: Int) {
        ...
        intent.putExtra(ConstantString.EXTRA_REMINDER_ID, Integer.toString(ID))
