...
public class HorizontalPickerRecyclerView extends RecyclerView implements OnItemClickedListener, View.OnClickListener, DatePickerListener {
    ...
    public void init(Context context, final int daysToPlus, final int initialOffset, final int mBackgroundColor, final int mDateSelectedColor, final int mDateSelectedTextColor, final int mTodayDateTextColor, final int mTodayDateBackgroundColor, final int mDayOfWeekTextColor, final int mUnselectedDayTextColor) {
        ...
        post(new Runnable() {
            ...
            public void run() {
                ...
                // selectItem(true, (int)((computeHorizontalScrollOffset() / itemWidth)));
                Log.e("TAG", "selectItem::::Get:::  " + adapter.getItem((int) ((computeHorizontalScrollOffset() / itemWidth))).getDay() + "  " +
                        (int) ((computeHorizontalScrollOffset() / itemWidth)));
            }
        });
    }
    ...
    public void onDateSelected(DateTime dateSelected) {
        Log.e("TAG", "onDateSelected::::Daaa " + dateSelected.toString());
    }
