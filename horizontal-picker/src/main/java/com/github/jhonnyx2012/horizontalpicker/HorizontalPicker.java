...
public class HorizontalPicker extends LinearLayout implements HorizontalPickerListener {
    ...
    public void setDate(final DateTime date) {
        rvDays.post(new Runnable() {
            ...
            public void run() {
                rvDays.setDate(date);
                /*int pos = rvDays.getPos(date);
                rvDays.selectItem(true,pos);*/
            }
        });
    }
    ...
    public void onDateSelected(Day item) {
        ...
        if (listener != null) {
            ...
            Log.e("TAG", "onDateSelected:::listener::Ifff not null  " );
        }else {
            Log.e("TAG", "onDateSelected:::listener::Null  " );
        }
        Log.e("TAG", "onDateSelected:::: "+item.getDay() +" " +item.getWeekDay());
    }
