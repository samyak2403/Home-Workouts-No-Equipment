...
//    public void setVisibleYRange(float minYRange, float maxYRange) {
//        float minScale = 1f / minYRange;
//        float maxScale = 1f / maxYRange;
//        mViewPortHandler.setMinimumScaleY(minScale);
//        mViewPortHandler.setMaximumScaleY(maxScale);
//    }
